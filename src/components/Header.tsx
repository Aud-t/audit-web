...
const Header = () => {
  ...
  return (
    <header
      className="absolute top-0 left-0 w-full h-[253px] overflow-hidden bg-cover bg-[50%_50%]"
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="h-[64px] w-full flex justify-between items-center px-16">
          <div className="font-bold text-[#f6f6f6] text-2xl">AI PROJECT</div>
        ...
        <div className="flex justify-center">
          <form
            onSubmit={onSearch}
            role="search"
            className="mt-8 h-12 w-[820px] flex items-center bg-[#ffffff26] rounded-[30px] overflow-hidden border border-solid border-[#cbcbcba1] backdrop-blur-[12.5px]"
          >
            <input
              id={searchId}
              type="search"
