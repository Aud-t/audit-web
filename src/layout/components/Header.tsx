...
const Header = () => {
  ...
  return (
    <header
      className="w-full h-[230px] bg-cover bg-[50%_50%]"
      style={{
    ...
    >
      ...
      <div className="w-full h-16 flex justify-between items-center px-16">
        <h1 className="font-bold text-[#f6f6f6] text-xl">AI PROJECT</h1>
        <nav aria-label="주요 메뉴" className="flex justify-between w-56">
          {/* 알림 */}
          <NotificationBox />
      ...
      <h1 className="mt-12 font-bold text-[#dddddd] text-2xl flex items-center justify-center">
        오늘의 이슈, 관점을 더하다
      </h1>
      <div className="flex justify-center">
        ...
        >
          <input
            ...
            className="ml-6 h-6 flex-1 bg-transparent outline-none border-0 text-[#f6f6f6] text-base placeholder:text-[#b3b3b3]"
          />
          <button
            type="submit"
