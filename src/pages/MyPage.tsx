  ...
  const recentData = [
    {
      ...
      category: '의료 개혁',
      title: '최근 본 뉴스 1',
      summary: '최근에 열람하신 사건의 요약 내용입니다. 유저의 히스토리를 기반으로 노출됩니다.',
      date: '2026.10.11',
    },
    {
      id: 302,
      ...
      <div className="max-w-[880px] mx-auto px-6 pt-10">
        ...
        <section className="flex flex-col md:flex-row md:items-end justify-between pb-8 border-b border-[#D7D7D7] mb-10">
          ...
          <div className="mt-6 md:mt-0 flex flex-col items-end">
            {/* 탈퇴하기 버튼 */}
            <button className="text-[11px] font-medium border border-gray-200 px-4 py-2 text-gray-400 hover:border-red-400 hover:text-red-400 transition-all mb-4">
              탈퇴하기
            </button>
